SEMANTIC_PAYLOAD_VERSION = "2026-06-05.1"
PROMPT_TEMPLATE_VERSION = "2026-06-05.1"
AI_OUTPUT_SCHEMA_VERSION = "2026-05-28.1"
DETERMINISTIC_ENGINE_VERSION = "semantic-engine-2026-06-05.1"


AI_DECISIONS = {
    "NO_CHANGE",
    "SUGGEST_CHANGE",
    "NEEDS_DETERMINISTIC_FIX",
